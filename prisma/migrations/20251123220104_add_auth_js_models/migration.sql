/*
  ...
  - You are about to drop the column `AIFeaturesActivated` on the `User` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "ArchivedTransaction" DROP CONSTRAINT "ArchivedTransaction_userId_fkey";
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "AIFeaturesActivated",
DROP COLUMN "hash",
DROP COLUMN "userId",
